                  ...
                  <div className="enroll_main col-sm-8">
                    <div className="enroll_card ">
                      <div className="enroll-now-container col-sm-12">
                        ...
                        <div className="container-column">
                          ...
                          Improve your fitness & be healthy
                          </p>
                          <p className="enroll_label">Personal Trainer at Home</p>
                          <a
                    ...
                    <div className="enroll_card ">
                      <div className="enroll-now-container col-sm-12">
                        ...
                        <div className="container-column">
                          <p className="enroll_label_header">
                          A balanced diet & Exercise works wonders!
                          </p>
                          <p className="enroll_label">
                          Diet Plans & Exercise plans
                          </p>
                          <a
                            className="enroll_button"
                    ...
                    <div className="enroll_card ">
                      <div className="enroll-now-container col-sm-12">
                        ...
                        <div className="container-column">
                          <p className="enroll_label_header">
                          Discover your inner serenity with Yoga!
                          </p>
                          <p className="enroll_label">Yoga Trainer at Home</p>
                          <a
                            className="enroll_button"
              ...
              <div className="home4">
                <div className="row home8">
                  ...
                  >
                    ...
                    <p className="iconText">Personal Trainer at Home</p>
                  </div>
                  <div
                    className="iconsallignment"
                  ...
                  >
                    ...
                    <p className="iconText">Yoga Trainer at Home</p>
                  </div>
                  <div className="iconsallignment ">
                    <a href="/diet">
                      <i className="flaticon-apple-measure icons_intro"></i>
                      <p className="iconText">
                        Effective Diets in atractive Prices
                      </p>
                    </a>
                  </div>
                  <div className="iconsallignment ">
            ...
            <section>
              ...
              <div className="container">
                ...
                >
                  ...
                  <div className="right col-sm-4 pickservice"></div>
                      ...
                      <div className="app_inner">
                        ...
                        <label for="tab-1">
                          ...
                          >
                            ...
                            <div className="tab_right">
                              <h4>Fitness Trainer at Home</h4>
                              <h4>Yoga Trainer at Home</h4>
                        ...
                        <label for="tab-2">
                          ...
                          >
                            ...
                            <div className="tab_right">
                              <p>
                                (Pay Rs. 99/- now ! And this will be refunded to

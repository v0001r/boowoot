            ...
            <div className="row">
              ...
              <div className="col-sm-8">
                <div className="feedback">
                  This Terms of Use agreement is effective as of
                  10-November-2019.
                </div>
                <div className="feedback">
                  ...
                  Bangalore, Karnataka-560096 IN (“Bangalore Corporate Office”).
                </div>
                <div className="feedback">
                ...
                <div className="feedback">
                  <strong>
                    YOU SPECIFICALLY AGREE THAT BY USING THE WEBSITE, YOU ARE AT
                    LEAST 18 YEARS OF AGE AND YOU ARE COMPETENT UNDER LAW TO
                    ENTER INTO A LEGALLY BINDING AND ENFORCEABLE CONTRACT.
                  </strong>
                </div>
                <div className="feedback">
                ...
                <div className="feedback">
                  <strong>
                    2. MODIFICATIONS TO TERMS AND CONDITIONS AND/OR PRIVACY
                    POLICY
                  </strong>
                </div>
                <div className="feedback">
                ...
                <div className="feedback">
                  ...
                  will otherwise act in accordance with the terms and conditions
                  of the Terms of Use and in accordance with all applicable
                  laws.
                </div>
                <div className="feedback">
                  <strong> 4. MEMBERSHIP ELIGIBILITY CRITERIA</strong>
                </div>
                <div className="feedback">
                  Use of the Website is available only to individuals who are at
                  least 18 years old and can form legally binding contracts
                  under applicable law. You represent, acknowledge and agree
                  that you are at least 18 years of age, and all registration
                  information that you submit is truthful and accurate. Your
                  ...
                  you must submit your name, email address or mobile number
                  through the account registration page on the Website and
                ...
                <div className="feedback">
                  <ul>
                    ...
                    <li>
                      ...
                      Service Professionals or Service Users information,
                      including but not limited to, names, addresses, phone
                      numbers, or email addresses, copying copyrighted text, or
                      otherwise misuse or misappropriate Website information or
                      content, including but not limited to, use on a
                    ...
                    <li>
                      ...
                      the operators of public search engines may use spiders or
                    ...
                    <li>
                      ...
                      identifiable data, including without limitation, names or
                      other Account information, from the Website, nor to use
                ...
                <div className="feedback">
                  <strong> 5. ADDITIONAL POLICIES</strong>
                </div>
                <div className="feedback">
                ...
                <div className="feedback">
                  <strong>6. PROHIBITIONS ON SUBMITTED CONTENT </strong>
                </div>
                <div className="feedback">
                  <ul>
                    <li>
                      You shall not upload, post, transmit, transfer,
                      disseminate, distribute, or facilitate distribution of any
                      content, including text, images, video, sound, data,
                      information, or software, to any part of the Website,
                      including your profile ("Profile"), the posting of your
                      Service ("Offer"), the posting of your desired Service
                      ("Want"), or the posting of any opinions or reviews in
                      connection with the Website, the Service, the Service
                      Professional, or the Service User ("Feedback") (all of the
                      foregoing content is sometimes collectively referred to
                      ...
                      Service Professionals; provides or create links to
                      external sites that violate the Terms of Use; is intended
                      to harm or exploit any individual under the age of 18
                      ("Minor") in any way; is designed to solicit, or collect
                      personally identifiable information of any Minor,
                      including, but not limited to, name, email address, home
                      address, phone number, or the name of his or her school,
                      (3)invades anyone's privacy, (4) is pornographic,
                      harassing, hateful, illegal,obscene, defamatory, libelous,
                      slanderous, threatening, discriminatory, racially,
                      culturally or ethnically offensive; incites, advocates, or
                      expresses pornography, obscenity, vulgarity,profanity,
                      hatred, bigotry, racism, or gratuitous violence;
                      encourages conduct that would be considered a criminal
                      offense, (5) contains or promotes an illegal or
                      unauthorized copyof another person's copyrighted work, (6)
                ...
                <div className="feedback">
                  <strong>7. PROHIBITIONS ON SENDING MESSAGES</strong>
                </div>
                <div className="feedback">
                  You will not send messages to other users containing (1)
                  unsolicited advertising or marketing of a service not offered
                  on the Website or an external website. (2)offers to make
                  national or international money transfers for amounts
                  exceeding the asking price of a service, with intent to
                  request a refund of any portion of the payment.
                </div>
                <div className="feedback">
                  <strong> 8. NO DISCRIMINATION</strong>
                </div>
                <div className="feedback">
                  Discriminatory Postings. Indian laws prohibit any preference,
                ...
                <div className="feedback">
                  <strong> 9. PROHIBITIONS WITH RESPECT TO SERVICES</strong>
                </div>
                <div className="feedback">
                  While using the Website, you shall not (1)if you violate any
                  laws, third-party rights, Account Policies, or any provision
                  of the Terms of Use, such as the prohibitions described above,
                  (2)post content or items in any inappropriate category or
                  areas on the Website, (3) if you fail to perform Services
                  purchased from you, unless the Service User fails to
                  materially meet the terms of the mutually agreed upon
                  agreement for the Services, refuses to pay, a clear
                  typographical error is made, or you cannot authenticate the
                  Service User's identity; manipulate the price of any
                  Service,(4)if you fail to deliver payment for Services
                  purchased by you, unless the Service Professional has
                  materially changed the description of the Service description
                ...
                <div className="feedback">
                  As a participant in the Website, you agree to use careful,
                  ...
                  Feedback for another user unless that user provides services
                  not included in the original Posting or not agreed to as part
                  of the Service to be provided; (b) leaving Feedback in order
                  to make the Service Professional or Service User appear better
                  than he or she actually is or was; and (c) including
                ...
                <div className="feedback">
                  <strong>Rules to be followed by Service Professionals</strong>
                </div>
                <div className="feedback">
                  <strong>
                    {" "}
                    11. PROFILES AND OFFERS MUST NOT BE FRAUDULENT
                  </strong>
                </div>
                <div className="feedback">
                  Subject to any exceptions set forth in these Terms of Use or
                  Additional Policies, if any, Service Professionals shall not:
                  (1) include any information in their Profile that is
                  fraudulent. (2) list Services or offers relating to any
                  Service in a category that is inappropriate to the Service
                  they are offering; (3) use misleading titles that do not
                  accurately describe the Service (4) misrepresent the location
                  at which they will provide a Service.
                </div>
                <div className="feedback">
                  <strong>
                ...
                <div className="feedback">
                  Subject to any exceptions set forth in these Terms of Use or
                  Additional Policies, if any, Service Professionals shall not:
                  (a) offer a catalog or a link to a third-party website from
                  which Service Users or any Registered User or user of the
                  Website may obtain the Service directly; (b) exceed multiple
                ...
                <div className="feedback">
                  <strong>
                    13. CONSENT FOR REACHING OUT VIA PHONE CALL, SMS, EMAIL OR
                    ANY OTHER FORM OF ELECTRONIC COMMUNICATION
                  </strong>
                </div>
                <div className="feedback">
                  It is further clarified that your registration on the Website
                  shall be deemed to be your consent to be contacted for the
                  purposes mentioned above, (i) on the mobile number shared by
                  you even if you are registered with the National Customer
                  Preference Register (NCPR) and have opted out of receiving
                  promotional calls and messages and (ii) by way of SMS or email
                  notifications or messages in any other electronic form
                </div>
                <div className="feedback">
                  <strong>
                    14. PRODUCTS UTILIZED WHILE RENDERING SERVICES TO THE
                    SERVICE USER(S)
                  </strong>
                </div>
                <div className="feedback">
                  ...
                  Professional to forfeit any fees earned on a cancelled
                  Posting; and/or (e) decrease the Service Professional's status
                  earned via the Feedback page.
                </div>
                <div className="feedback">
                  <strong>
                    <h4>Rules to be followed by Service Users</h4>
                  </strong>
                </div>
                <div className="feedback">
                  <strong>
                    15. SERVICE USERS SHALL NOT TAKE ANY OF THE FOLLOWING
                    ACTIONS:
                  </strong>
                </div>
                <div className="feedback">
                  (a) commit to purchasing or using a Service without paying;
                  (b) sign up for, negotiate a price for,use, or otherwise
                  solicit a Service with no intention of following through with
                  your use of or payment for the Service; (c) agree to purchase
                  a Service when you do not meet the Service Professional's
                  terms as outlined in the Posting, or agree to purchase a
                  Service with the intention of disrupting a Posting; or (d)
                  ...
                  Account; (d) cause the Service Professional to forfeit any
                  fees earned on a cancelled Posting; and/or (e) decrease the
                  Service Professional's status earned via the Feedback page.
                </div>
                <div className="feedback">
                  <strong>
                    <h4>Use of Submitted Content16.</h4>
                  </strong>
                </div>
                <div className="feedback">
                  <strong>16.NO CONFIDENTIALITY</strong>
                </div>
                <div className="feedback">
                  ...
                  (including, but not limited to ensuring payment of fees by
                  users), or (v) as may be required or necessary to deter
                  illegal behavior (including, but not limited to, fraud).
                </div>
                <div className="feedback">
                  <strong>17. YOUR REPRESENTATIONS AND WARRANTIES</strong>
                </div>
                <div className="feedback">
                  You shall be solely responsible for your own Submitted Content
                  and the consequences of postingor publishing it. You agree to
                  pay for all royalties, fees, and any other monies owing any
                  person by reason of any Submitted Content posted by you to or
                  through the Website.
                </div>
                <div className="feedback">
                  <strong>
                ...
                <div className="feedback">
                  ...
                  formats and through any media channels. You also herebygrant
                  each user of the Website a non-exclusive license to access
                  your Submitted Content through the Website, and to use,
                  reproduce, distribute, prepare derivative works of, display
                  and perform such Submitted Content as permitted through the
                  functionality of the Website and under these Terms of Use. The
                  foregoing license granted by you terminates once you remove or
                  delete the Submitted Content from the Website.You acknowledge
                  and understand that the technical processing and transmission
                  of the Website, including your Submitted Content, may involve
                  (a) transmissions over various networks; and (b) changes to
                  conform and adapt to technical requirements of connecting
                  networks or devices.You may remove your Submitted Content from
                  the Website at any time. If you choose to remove your
                  Submitted Content, the license granted above will
                ...
                <div className="feedback">
                  ...
                  distribution or seek recognition if the Suggestions are in
                  fact implemented.
                </div>
                ...
                <div className="feedback">
                  ...
                  representative list of such works at that site; (b) a written
                  statement that you have agood faith belief that the disputed
                  use is not authorized by the copyright and/or trademark
                  owner,its agent, or the law;(c) identification of the material
                  ...
                  perjury, that the information in your report is accurate and
                  that you are theowner of the exclusive right or authorized to
                  act on the behalf of the owner of the exclusive right.A
                ...
                <div className="feedback">
                  <strong>
                    <h4>Modifications to or Termination of Website</h4>
                  </strong>
                </div>
                <div className="feedback">
                  ...
                  participation in the use of the Website (or any part thereof),
                ...
                <div className="feedback">
                  The content on the Website (exclusive of all Submitted
                  Content), including without limitation, the text, software,
                ...
                <div className="feedback">
                  ...
                  irrespective of whether the job leads eventually result in a
                  transaction or exchange of consideration for the service
                  requested. In order to be eligible to make such Lead Fee
                  payment, Service Professionals shall be required to make
                  advance payments (“Credits”) from which the Lead Fee may be
                  deducted as and when necessary. Whenever the Credits fall
                  below the prescribed threshold, the Service Professional shall
                  be prompted to refill the Credits in order to continue
                  enjoying the ability to follow up on leads and contacting
                  Service Users.
                </div>
                <div className="feedback">
                  The service professional is entitled to refund of credits that
                  is credited back in their wallet in the following conditions:
                </div>
                <div>
                  <ol>
                    <li>
                      Refunds are processed when customer cancels request{" "}
                    </li>
                    <li>
                      Refunds are processed if the customer has not viewed quote
                      and not cancelled request 4 days after your response
                    </li>
                  </ol>
                </div>
                <div className="feedback">
                  In the event, (i) the job lead is identified to be
                  non-genuine, or (ii) the Service User within 48 hours of
                  posting a request on the Website withdraws the same by way of
                  the Website or the mobile application only, or (iii) the
                  Service Professional pays the Lead Fee to respond to the
                ...
                <div className="feedback">
                  ...
                  payment gateway or other payment method designated at the time
                ...
                <div className="feedback">
                  ...
                  service package payment only when you go ahead with the
                  service package and make payment for the same. By paying this
                  nominal amount you are only assuring us that you are a genuine
                  and valuable customer for us.All monies paid by Service
                  Professionals in form of “Credits” are non-interest bearing.
                  Unutilized and unclaimed "Credits" for a period of more than
                  364 days from the date of purchaseof "Credits" shall expire
                  and stand forfeited. No refunds of credits will be processed
                ...
                <div className="feedback">
                  You understand that we are acting solely as an intermediary
                  for the collection of rents and fees between a Service User
                  and a Service Professional who choose to enter into an
                  Agreement for Service. Because state and local tax laws vary
                  significantly by locality, you understand and agreethat you
                ...
                <div className="feedback">
                  <strong> 27. NO AGENCY, PARTNERSHIP OR JOINT VENTURE</strong>
                </div>
                <div className="feedback">
                ...
                <div className="feedback">
                  <strong>
                    <h4>DISPUTES BETWEEN REGISTERED USERS</h4>
                  </strong>
                </div>
                <div className="feedback">
                  Subject to the provisions regarding disputes between Website
                  participants in connection with Feedback, your interactions
                  with individuals and/or organizations found on or through the
                  Website, including payment of and performance of any Service,
                  and any other terms, conditions, warranties or representations
                  associated with such transactions or dealings, are solely
                  between you and such individual or organization. You should
                ...
                <div className="feedback">
                  ...
                  UNDISCLOSED, ARISING OUTOF OR IN ANY WAY RELATED TO SUCH
                  DISPUTES AND/OR THE WEBSITE OR ANY SERVICE PROVIDED
                  THEREUNDER.
                </div>
                <div className="feedback">
                  <strong>
                ...
                <div className="feedback">
                  The Terms of Use shall be governed in all respects by the laws
                  of India and any legal proceeding arising out of this
                ...
                <div className="feedback">
                  ...
                  contact forms and/or phone numbers to other websites or
                  resources, including, without limitation, social networking,
                  blogging and similar websites through which you are able to
                ...
                <div className="feedback">
                  ...
                  ADVANTAGE) WHATSOEVER RESULTING FROM ANY (I) ACCESS TO OR USE
                  OF THEWEBSITE OR ANY SERVICES OFFERED BY ANY SERVICE
                  PROFESSIONALS VIA THE WEBSITE, INCLUDING SERVICES PROVIDED
                  PURSUANT TO AN AGREEMENT FORMED INDEPENDENTLY OF THE WEBSITE,
                  WHETHER OR NOT AN AGREEMENT FOR SERVICE FORMED VIA THE WEBSITE
                  IS IN EFFECT; (II) ERRORS, MISTAKES, ORINACCURACIES OF DATA,
                  MARKS, CONTENT, INFORMATION, MATERIALS OR SUBSTANCE OF THE
                  WEBSITE OR SUBMITTED CONTENT; (III) ANY UNAUTHORIZED ACCESS TO
                  ...
                  TRANSMITTED TO OR THROUGH THE WEBSITE BY ANY THIRD PARTY; (V)
                  ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM THE
                  WEBSITE; (VI)ANY ERRORS OR OMISSIONS IN ANY DATA, CONTENT,
                  INFORMATION, MATERIALS OR SUBSTANCE OF THE WEBSITE OR
                  SUBMITTED CONTENT; (VII) ANY FAILED NEGOTIATIONS FOR A
                  SERVICE, ANY DISPUTES THAT ARISE DURING OR AFTER THE
                  NEGOTIATION OF A SERVICE OR THE FORMATION OF A CONTRACT FOR A
                  SERVICE, OR ANY OTHER DISPUTE THAT ARISES BETWEEN USERS OF THE
                  WEBSITE; (VIII) ANY DEFAMATORY, OFFENSIVE, OR ILLEGAL CONDUCT
                  OF ANY THIRD PARTY OR SERVICE USER OR SERVICE PROFESSIONAL; OR
                  (IX) ANY USE OF ANY DATA, MARKS, CONTENT, INFORMATION,
                  MATERIALS OR SUBSTANCE OF THE WEBSITE OR SUBMITTED CONTENT
                ...
                <div className="feedback">
                  ...
                  YOU VISIT, INCLUDING THOSE DIRECTED BY THE LINKS CONTAINED ON
                  THE WEBSITE.
                </div>
                <div className="feedback">
                ...
                <div className="feedback">
                  ...
                  EXPRESS, IMPLIED, STATUTORY OR OTHERWISE, AND MAKE NO
                  WARRANTIES, REPRESENTATIONS, OR GUARANTEES IN CONNECTION WITH
                  THIS WEBSITE, THE SERVICES OFFERED ON OR THROUGH THIS WEBSITE,
                  ANY DATA, MATERIALS, SUBMITTED CONTENT, RELATING TO THE
                  QUALITY, SUITABILITY, TRUTH, ACCURACY OR COMPLETENESS OF ANY
                  INFORMATION OR MATERIAL CONTAINED OR PRESENTED ON THIS
                  WEBSITE, INCLUDING WITHOUT LIMITATION THE MATERIALS, DATA AND
                  SUBMITTED CONTENT OF OTHER USERS OF THIS SITE OR OTHER THIRD
                  PARTIES. UNLESS OTHERWISE EXPLICITLY STATED, TO THE MAXIMUM
                  EXTENT PERMITTED BY APPLICABLE LAW, THIS WEBSITE, THE SERVICES
                  OFFERED ON OR THROUGH THIS WEBSITE, DATA, MATERIALS, SUBMITTED
                  CONTENT, AND ANY INFORMATION OR MATERIAL CONTAINED OR
                  ...
                  WHICH MAY BE TRANSMITTED TO OR THROUGH THE WEBSITE BY ANY
                  THIRD PARTY, ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO
                  OR FROM THE WEBSITE, ANY DEFAMATORY, OFFENSIVE, OR ILLEGAL
                  CONDUCT OF ANY THIRD PARTY OR SERVICE USER OR SERVICE
                  PROVIDER, OR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A
                  ...
                  THE PUBLISHING OR POSTING OF ANY MATERIAL THROUGH ANY MEDIUM
                  OR IN ANY ENVIRONMENT, YOU SHOULDUSE YOUR BEST JUDGMENT AND
                ...
                <div className="feedback">
                  ...
                  strikes, unavailability of necessary utilities, blackouts,
                ...
                <div className="feedback">
                  ...
                  OR DEBT, AND EXPENSES (INCLUDING BUT NOT LIMITED TO ATTORNEYS'
                  FEES) ARISING FROM YOUR USE OF, ACCESS TO, AND PARTICIPATION
                  IN THE WEBSITE; YOUR VIOLATION OF ANY PROVISION OF THE TERMS
                  OF USE, INCLUDING THE PRIVACY POLICY; YOUR VIOLATION OF ANY
                  THIRD-PARTY RIGHT, INCLUDING WITHOUT LIMITATION ANY COPYRIGHT,
                  PROPERTY, PROPRIETARY, INTELLECTUAL PROPERTY, OR PRIVACY
                  RIGHT; OR ANYCLAIM THAT YOUR SUBMITTED CONTENT CAUSED DAMAGE
                ...
                <div className="feedback">
                  ...
                  provided in the Terms of Use, there shall be no third-party
